namespace ReturnWorkItemForReworkAfterVeto

-- EMC-DIGEST: slice:name=Return Work Item for Rework After Veto;slug=return-work-item-for-rework;kind=automation;description=Given GateVetoed event emitted, When veto recorded, Then WorkItemReturnedForRework event emitted with target_phase (WriteTest for test-review veto, Implement for implementation-review veto); work item transitions back to ready in that phase with veto reason attached
-- EMC generated Lean4 business slice model.
def sliceName := "Return Work Item for Rework After Veto"

def sliceSlug := "return-work-item-for-rework"
...
def sliceDescription := "Given GateVetoed event emitted, When veto recorded, Then WorkItemReturnedForRework event emitted with target_phase (WriteTest for test-review veto, Implement for implementation-review veto); work item transitions back to ready in that phase with veto reason attached"
...
theorem sliceIdentityIsStable : sliceName = "Return Work Item for Rework After Veto" := rfl
...
end ReturnWorkItemForReworkAfterVeto
